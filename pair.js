...
const config = {
    ...
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb9GFr57T8bWuZVAOg0C'
};

const owner = 'thuhina vimukthi and chethana hasaral';
const repo = 'DARK-MATTER-XMD.';
...
╰───────────────⭓`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: 'Powered by DARK-MATTER-XMD',
                serverMessageId: -1
            }
        };
...
╰───────────────⭓`;
        ...
        const messageContext = {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363397722863547@newsletter',
                newsletterName: 'Powered by DARK-MATTER-XMD🌹 TECH',
                serverMessageId: -1
            }
        };
...
`;
    ...
    const messageContext = {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: '120363397722863547@newsletter',
            newsletterName: 'DARK-MATTER-XMD',
            serverMessageId: -1
        }
    };
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: 'DARK-MATTER-XMD' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              ...
              sections: [
                {
                  ...
                  highlight_label: 'DARK-MATTER-XMD',
                  rows: [
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *DARK-MATTER-XMD ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 DARK-MATTER-XMD ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ DARK-MATTER-XMD
╭───────────────⭓
